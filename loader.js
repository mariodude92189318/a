// JS Loader that makes you be able to play the mario wasm.
console.log("Starting SM64-synicaledit-v6")
...
if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) {
  ...
  setWindowTitle = function(title) { document.title = 'Super Mario 64' };
} else
{
...
var wasmBinaryFile = 'sm64ROM.wasm'
